...
#ifndef FIADMM_GD_LINE_SEARCH
#define FIADMM_GD_LINE_SEARCH
...
namespace comlkit {
    ...
    Vector gdLineSearch(const ContinuousFunctions &c, const Vector &x0, double alpha = 1, const double gamma = 1e-4,
