...
#ifndef FIADMM_GD_BARZILAI_BORWEIN
#define FIADMM_GD_BARZILAI_BORWEIN
...
namespace comlkit {
    ...
    Vector
    gdBarzilaiBorwein(const ContinuousFunctions &c, const Vector &x0, double alpha = 1, const double gamma = 1e-4,
